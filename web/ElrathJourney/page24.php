...
<!---------------------------------------------------------------Choice 1------------->
                    <a href="page1.php">
                        <p>Go to the Four-Way Intersection</p>
                    </a>
                </div>
                <div class="col-xs-5"></div>
            </div>
        </div>
        <h3>18.	In a flurry of anger you bring your foot crushing into the Skeletons head and it goes still as its skull is crushed.</h3>
